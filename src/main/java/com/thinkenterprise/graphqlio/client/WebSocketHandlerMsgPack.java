...
public class WebSocketHandlerMsgPack extends BinaryWebSocketHandler {
	...
	protected void handleBinaryMessage(WebSocketSession session, BinaryMessage message) throws Exception {
		...
		System.out.println(this.getClass().getName() + "::getFromMsgPack : " + GsWebSocketHandler.getFromMsgPack(message));
	}
